                      ...
                      {editingLimit === cat ? (
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 rounded border border-gray-300 px-2 py-1 text-xs focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand"
                          />
                          <button
                            type="button"
